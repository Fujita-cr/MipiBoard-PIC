...
//////////////////////////////////////////////////////////////////////////////////////
// バージョン変更時は、下記の手順で行う
// １．「app boot」のコンフィグに設定する
// ２．「mipiboard_HID」のプロジェクトを右クリックして「Clean and build」
// ３．出力されたHexファイルの日付時刻を確認する。
// ４．main.cのバージョン履歴に変更点の説明を書く
// ５．main.cのm_versionのバージョン番号を書き換える（変数定義の最後辺り）
// ６．git commitする
//////////////////////////////////////////////////////////////////////////////////////
...
//20240528 V17・・・画面非表示とサウンド問題の対策として下記の対応
...
///////////////////////////////////////////////////////////////////////////////
const uint16_t   m_version = 17;  //プログラムのバージョン情報 テスト版のときは100XXとかにする
///////////////////////////////////////////////////////////////////////////////
